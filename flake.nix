{
  inputs = {
    ...
    skills-ms.url = "github:Bootstrap-Academy/skills-ms/b5f9f8a52397332737c4ae8bb91003aa9f7e881d";
    ...
    skills-ms-develop.url = "github:Bootstrap-Academy/skills-ms/b5f9f8a52397332737c4ae8bb91003aa9f7e881d";
